        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalReadBooks = table.Column<int>(type: "int", nullable: false),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCopies_Users_BorrowerId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A long narrative fictional work.", "Novel" },
                    { 2, "Books that evoke positive emotions and comfort.", "Feelgood" },
                    { 3, "Books that narrate the life story of a person.", "Biography" },
                    { 4, "Books filled with suspense and excitement.", "Thriller" },
                    { 5, "Fictional narrative works of significant length.", "Novels" },
                    { 6, "Books that explore historical events and periods.", "History" },
                    { 7, "Books that involve imaginative worlds or futuristic science.", "Fantasy & SciFi" },
                    { 8, "Books based on factual information and real events.", "Non-Fiction" },
                    { 9, "Books that involve solving crimes or mysteries.", "Crime" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "CreatedAt", "DateOfBirth", "Description", "Email", "FullName", "ImageUrl", "IsActive", "TotalReadBooks", "Username", "role" },
                values: new object[,]
                {
                    { -1, "New York, USA", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "john@example.com", "John Smith", null, false, 0, "john123", 2 },
                    { 1, "Plovdiv, Bulgaria", new DateTime(2025, 5, 28, 18, 5, 46, 350, DateTimeKind.Local).AddTicks(5136), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@admin.com", "AdminAdmin", null, false, 0, "Admin", 0 }
                });
